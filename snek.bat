...
:: HEY DONT FORGET ME AND MY FRIEND, WE SENT YA DIS Dante aka justatmeasthis and chance aka NIL
::
...
call :resize
set "loadAvailable="
echo SNAKE.BAT v4.0 by Dave Benham, Found by Dante aka justatmeasthis
echo(
echo Main Menu:
echo(
echo   N - New game
